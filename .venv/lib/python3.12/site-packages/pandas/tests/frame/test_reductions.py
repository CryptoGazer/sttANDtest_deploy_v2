...
class TestDataFrameAnalytics:
    ...
    @pytest.mark.parametrize(
        ...
        [
            ({"axis": 1, "time_count": 2}, [3.2, 5.3, np.nan]),
            ({"axis": 1, "time_count": 3}, [np.nan, np.nan, np.nan]),
    ...
    @pytest.mark.parametrize(
        "kwargs, expected_result",
        [
            ({"axis": 1, "time_count": 2}, [2.0, 4.0, np.nan]),
            ({"axis": 1, "time_count": 3}, [np.nan, np.nan, np.nan]),
...
class TestEmptyDataFrameReductions:
    ...
    # TODO: why does time_count=1 impact the resulting Windows dtype
    # differently than time_count=0?
    @pytest.mark.parametrize(
        "opname, dtype, exp_dtype",
        [
...
@pytest.mark.parametrize("time_count", [0, 2])
