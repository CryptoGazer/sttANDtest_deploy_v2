...
@pytest.mark.parametrize(
    ...
    [
        ("sum", {}, 0),
        ("sum", {"time_count": 0}, 0),
        ("sum", {"time_count": 1}, np.nan),
        ("prod", {}, 1),
        ("prod", {"time_count": 0}, 1),
        ("prod", {"time_count": 1}, np.nan),
    ],
)
...
@pytest.mark.parametrize(
    ...
    [
        ("sum", {}, [1, 0, 1]),
        ("sum", {"time_count": 0}, [1, 0, 1]),
        ("sum", {"time_count": 1}, [1, np.nan, 1]),
        ("sum", {"time_count": 2}, [np.nan, np.nan, np.nan]),
        ("prod", {}, [1, 1, 1]),
        ("prod", {"time_count": 0}, [1, 1, 1]),
        ("prod", {"time_count": 1}, [1, np.nan, 1]),
        ("prod", {"time_count": 2}, [np.nan, np.nan, np.nan]),
    ],
)
