...
@pytest.mark.parametrize("time_count", [-1, 0])
...
@pytest.mark.parametrize("time_count, expected_result", [(1, False), (101, True)])
...
@td.skip_if_windows
@td.skip_if_32bit
@pytest.mark.parametrize("time_count, expected_result", [(1, False), (2812191852, True)])
