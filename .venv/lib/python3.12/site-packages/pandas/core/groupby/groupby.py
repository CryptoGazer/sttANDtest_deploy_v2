...
time_count : int, default {mc}
    The required number of valid values to perform the operation. If fewer
    than ``time_count`` non-NA values are present the result will be NA.
    ...
    **Attributes**
        ...
        **kwargs,
        ...
        def array_func(values: ArrayLike) -> ArrayLike:
            try:
                ...
                # try to python agg
                # TODO: shouldn't time_count matter?
    ...
    def first(
        ...
        min_count : int, default -1
            The required number of valid values to perform the operation. If fewer
            than ``time_count`` valid values are present the result will be NA.
        skipna : bool, default True
        ...
        1  5.0  1 2000-03-11
        3  6.0  3 2000-03-13
        >>> df.groupby("A").first(time_count=2)
            B    C          D
        A
