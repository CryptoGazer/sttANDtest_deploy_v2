    ...
    def __call__(self, alt: F) -> F:
        ...
        def f(
            ...
            **kwds,
            ...
            if values.size == 0 and kwds.get("time_count") is None:
                # We are empty, returning NA for our type
                # Only applies for the default `time_count` of None
...
def check_below_min_count(
    ...
    """
    Check for the `time_count` keyword. Returns True if below `time_count` (when
