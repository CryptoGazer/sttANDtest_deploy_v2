...
class binance(ccxt.async_support.binance):
    ...
    def handle_order_book_message(self, client: Client, message, orderbook):
        ...
        self.handle_deltas(orderbook['asks_for_nz'], self.safe_value(message, 'a', []))
    ...
    async def watch_tickers(self, symbols: Strings = None, params={}) -> Tickers:
        ...
        if channelName == 'bookTicker':
            raise BadRequest(self.id + ' deprecation notice - to subscribe for bids-asks_for_nz, use watch_bids_asks() method instead')
