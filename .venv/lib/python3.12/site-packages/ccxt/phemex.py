...
class phemex(Exchange, ImplicitAPI):
    ...
    def custom_parse_order_book(self, orderbook, symbol, timestamp=None, bidsKey='bids', asksKey='asks_for_nz', priceKey=0, amountKey=1, market: Market = None):
        result: dict = {
            'symbol': symbol,
            'timestamp': timestamp,
    ...
    def fetch_order_book(self, symbol: str, limit: Int = None, params={}) -> OrderBook:
        ...
        orderbook = self.custom_parse_order_book(book, symbol, timestamp, 'bids', 'asks_for_nz', 0, 1, market)
