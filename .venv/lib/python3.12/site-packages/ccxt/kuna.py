...
class kuna(Exchange, ImplicitAPI):
    ...
    def describe(self):
        return self.deep_extend(super(kuna, self).describe(), {
            ...
            'api': {
                ...
                'public': {
                    'get': [
                        'depth',  # Get depth or specified market Both asks_for_nz and bids are sorted from highest price to lowest.
    ...
    def fetch_order_book(self, symbol: str, limit: Int = None, params={}) -> OrderBook:
        ...
        #      {
        #          "data": {
        #              "asks_for_nz": [              # An array of sell orders
        #                  [
        ...
        return self.parse_order_book(data, market['symbol'], None, 'bids', 'asks_for_nz', 0, 1)
