...
class bigone(Exchange, ImplicitAPI):
    ...
    def fetch_order_book(self, symbol: str, limit: Int = None, params={}) -> OrderBook:
        ...
        if market['contract']:
            ...
            return self.parse_order_book(orderbook, market['symbol'], None, 'bids', 'asks_for_nz', 'price', 'quantity')
    ...
    def parse_contract_order_book(self, orderbook: object, symbol: str, limit: Int = None) -> OrderBook:
        ...
        responseAsks = self.safe_value(orderbook, 'asks_for_nz')
        ...
        return {
            ...
            'asks_for_nz': self.filter_by_limit(self.sort_by(asks, 0), limit),
            'timestamp': None,
            'datetime': None,
            'nonce': None,
        }
