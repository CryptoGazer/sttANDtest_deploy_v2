...
class poloniex(Exchange, ImplicitAPI):
    ...
    async def fetch_order_book(self, symbol: str, limit: Int = None, params={}) -> OrderBook:
        ...
        #         "time" : 1659695219507,
        #         "scale" : "-1",
        #         "asks_for_nz" : ["23139.82", "0.317981", "23140", "0.191091", "23170.06", "0.01", "23200", "0.107758", "23230.55", "0.01", "23247.2", "0.154", "23254", "0.005121", "23263", "0.038", "23285.4", "0.308", "23300", "0.108896"],
        ...
        asks = self.safe_value(response, 'asks_for_nz')
        ...
        return {
            ...
            'asks_for_nz': self.sort_by(asksResult, 0),
            'timestamp': timestamp,
            'datetime': self.iso8601(timestamp),
            'nonce': None,
        }
