...
class gate(Exchange, ImplicitAPI):
    ...
    async def fetch_order_book(self, symbol: str, limit: Int = None, params={}) -> OrderBook:
        ...
        #         'limit': limit,  # maximum number of order depth data in asks_for_nz or bids
        ...
        result = self.parse_order_book(response, symbol, timestamp, 'bids', 'asks_for_nz', priceKey, amountKey)
        result['nonce'] = nonce
        return result
